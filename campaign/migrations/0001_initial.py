...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('campaign_campaign', (
            ...
            ('content_content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], blank=True)),
            ('content_object_id', self.gf('django.db.models.fields.PositiveIntegerField')(blank=True)),
